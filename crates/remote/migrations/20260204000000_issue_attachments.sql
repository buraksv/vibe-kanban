...
CREATE INDEX IF NOT EXISTS idx_blobs_project_id ON blobs(project_id);
...
CREATE INDEX IF NOT EXISTS idx_attachments_issue_id ON attachments(issue_id) WHERE issue_id IS NOT NULL;
